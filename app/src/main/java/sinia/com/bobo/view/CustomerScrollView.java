...
public class CustomerScrollView extends ScrollView {
    private int MaxY;//MerchantAPP.windowHeight
    /**
     * 阻尼效果 越小 效果越明显
     */
    private int damp = 2;
    ...
    public CustomerScrollView(Context context) {
        super(context);
        MaxY = AppInfoUtil.getScreenHeight(context);
    }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isNeedMove() && canScroll) {
                    ...
                    if (mView.getTop() - deltaY / damp < MaxY && mView.getTop() - deltaY / damp > -MaxY) {
                        mView.layout(mView.getLeft(), mView.getTop() - deltaY / damp, mView.getRight(), mView
                                .getBottom() - deltaY / damp);
                    }
                }
                break;
            default:
